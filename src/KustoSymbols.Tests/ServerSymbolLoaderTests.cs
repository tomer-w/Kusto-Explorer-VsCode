        ...
        public async Task TestLoadDatabaseAsync_Tables()
        {
            await Test([
                ...
                async (loader) =>
                {
                    var dbSymbol = await loader.LoadDatabaseAsync("MyDb");
                    Assert.IsNotNull(dbSymbol);
                    Assert.HasCount(2, dbSymbol.Members);
        ...
        public async Task TestLoadDatabaseAsync_Functions()
        {
            await Test([
                ...
                async (loader) =>
                {
                    var dbSymbol = await loader.LoadDatabaseAsync("MyDb");
                    Assert.IsNotNull(dbSymbol);
                    Assert.HasCount(1, dbSymbol.Functions);
        ...
        public async Task TestLoadDatabaseAsync_ExternalTables()
        {
            await Test(
                ...
                async (loader) =>
                {
                    var dbSymbol = await loader.LoadDatabaseAsync("MyDb");
                    Assert.IsNotNull(dbSymbol);
                    Assert.HasCount(1, dbSymbol.ExternalTables);
        ...
        public async Task TestLoadDatabaseAsync_MaterializedViews()
        {
            await Test(
                ...
                async (loader) =>
                {
                    var dbSymbol = await loader.LoadDatabaseAsync("MyDb");
                    Assert.IsNotNull(dbSymbol);
                    Assert.HasCount(1, dbSymbol.MaterializedViews);
        ...
        public async Task TestLoadDatabaseAsync_EntityGroups()
        {
            await Test(
                ...
                async (loader) =>
                {
                    var dbSymbol = await loader.LoadDatabaseAsync("MyDb");
                    Assert.IsNotNull(dbSymbol);
                    Assert.HasCount(1, dbSymbol.EntityGroups);
        ...
        public async Task TestLoadDatabaseAsync_GraphModels()
        {
            await Test(
                ...
                async (loader) =>
                {
                    var dbSymbol = await loader.LoadDatabaseAsync("MyDb");
                    Assert.IsNotNull(dbSymbol);
                    Assert.HasCount(1, dbSymbol.GraphModels);
                    var gm = dbSymbol.GetGraphModel("GM");
                    Assert.IsNotNull(gm);
                    Assert.HasCount(1, gm.Edges);
                    Assert.HasCount(1, gm.Nodes);
                    Assert.HasCount(3, gm.Snapshots);
                });
        }
    }
}
