...
export function activate(context: vscode.ExtensionContext, client: LanguageClient): void
{
    ...
    client.onNotification('workspace/semanticTokens/refresh', async () =>
    {
        // Force VS Code to invalidate semantic token cache by making a real edit
    ...
    // Force refresh semantic tokens for already-open Kusto documents
