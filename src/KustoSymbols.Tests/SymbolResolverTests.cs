...
namespace Tests
{
    ...
    public class SymbolResolverTests
    {
        ...
        public async Task TestAddReferencedDatabasesAsync_ReferenceInQuery()
        {
            ...
            Assert.HasCount(1, globals.Cluster.Databases);
            ...
            Assert.HasCount(2, newCode.Globals.Cluster.Databases);
        ...
        public async Task TestAddReferencedDatabasesAsync_NoDefaultDatabase()
        {
            ...
            Assert.IsEmpty(globals.Cluster.Databases);
            ...
            // both databases should exist now
            Assert.HasCount(1, newCode.Globals.Cluster.Databases);
        ...
        public async Task TestAddReferencedDatabasesAsync_NoDefaultCluster_ClusterSpecified()
        {
            ...
            Assert.IsEmpty(newCode.Globals.Cluster.Databases);
        ...
        public async Task TestAddReferencedDatabasesAsync_CodeScript()
        {
            ...
            // both databases should exist now
            Assert.HasCount(2, newScript.Globals.Cluster.Databases);
        ...
        public async Task TestAddReferencedDatabasesAsync_MultipleHops()
        {
            ...
            Assert.HasCount(3, newCode.Globals.Cluster.Databases);
        ...
        public async Task TestAddReferencedDatabasesAsync_CodeScript_MultipleHops()
        {
            ...
            // all three databases should exist now
            Assert.HasCount(3, newScript.Globals.Cluster.Databases);
        }
        ...
        public async Task TestAddReferencedDatabasesAsync_MultipleClusters()
        {
            ...
            Assert.HasCount(1, globals.Clusters);
            ...
            Assert.HasCount(2, newCode.Globals.Clusters);
        ...
        public async Task TestAddReferencedDatabasesAsync_MultipleHops_MultipleClusters()
        {
            ...
            Assert.HasCount(3, newCode.Globals.Clusters);
